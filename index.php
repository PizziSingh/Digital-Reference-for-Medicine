...
<!--fullscreen image-->
<div class="fullscreen-parallax bg-parallax" data-parallax='{"speed": 0.2}' style='background-image: url(images/back_img1.jpg)'>
    <div class="fullscreen-inner">
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="text-center">
                        <h1>Find Medicine & Condition</h1>

                        <form method="POST" action="medicine-detail.php" role="form">
                            <div class="input-group input-group-lg">
                                <input type="text" class="form-control " name="medname" id="medicine" autocomplete="off" placeholder="Search for drugs, medicine, disease ... ">
                                <span class="input-group-btn">
                                    <input type="submit" class="btn btn-primary btn-lg" id="search" value="Search" />
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', 'li', function() {
            ...
            $('#medicine').val($.trim(click_text[0]));
            // $('#medicine').val($(".list-group-item").text());
            $('#medicineresult').fadeOut();
